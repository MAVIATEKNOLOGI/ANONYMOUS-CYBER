...
\____/| .__/ \__,_|_| |_| |_| \____/|_| |_| |_|___/
      | |                                          
      |_|  '''+W+'Creator : ./MAVIA TEKNOLOGI\n\t\tYT : ANONYMOUS CYBER I.N.A')
	...
	def Spam():
		...
		if PilihTools == '1':
			...
			os.system('xdg-open http://wa.me/6285883449665?text=Hallo')
...
if __name__ == '__main__':
	...
	sleep(2)
	os.system('clear')
	os.system('xdg-open https://youtube.com/channel/UC88izQKltz49PE8Z4I8dVCQ')
	sleep(7)
	Spam()